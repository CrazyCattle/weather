export default function initialize(data) {
  ...
  (function(w) {
      ...
      */
      ...
      var speck_count = 1000; //This determines how many particles will be made.
